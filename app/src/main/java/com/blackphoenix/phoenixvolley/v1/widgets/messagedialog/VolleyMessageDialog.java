...
public abstract class VolleyMessageDialog extends AlertDialog {

    private TextView textViewContent;
    VolleyMessageDialogInterface progressDialogDataInterface;
    ...
    public abstract void onInterfaceReady(VolleyMessageDialogInterface dialogInterface);
    public abstract void onTimedOut();
    public abstract void onDismissed();

    public VolleyMessageDialog(Context context, String text) {
        super(context, R.style.PxVolleyDialogTheme);
        this.progressText = text;
        this._context = context;
    }

    public VolleyMessageDialog(Context context, int themeResId, String text) {
        super(context, themeResId);
        this.progressText = text;
        this._context = context;
    }

    public VolleyMessageDialog(Context context, int themeResId) {
        super(context, R.style.PxVolleyDialogTheme);
        iconThemeResID = themeResId;
        this._context = context;
    }

    public VolleyMessageDialog(Context context, int themeResId, String text, long timeout /* TIMEOUT in Milliseconds*/) {
        super(context, themeResId);
        this.progressText = text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialogDataInterface = new VolleyMessageDialogInterface() {
            @Override
    ...
    public VolleyMessageDialogInterface getProgressDialogDataInterface(){
