...
/**
 * Created by Praba on 08-03-2017.
 */
...
public class VolleyJsonMultipartRequest extends Request<JSONObject> {
     ...
     */
    public VolleyJsonMultipartRequest(String url, Map<String, String> headers,
     ...
     */
    public VolleyJsonMultipartRequest(int method, String url,
                                      Response.Listener<JSONObject> listener,
                                      Response.ErrorListener errorListener) {
