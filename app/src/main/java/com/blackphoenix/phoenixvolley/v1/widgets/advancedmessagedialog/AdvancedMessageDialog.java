...
public abstract class AdvancedMessageDialog extends AlertDialog {

    private TextView textViewContent;
    AdvancedMessageDialogInterface progressDialogDataInterface;
    ...
    public abstract void onInterfaceReady(AdvancedMessageDialogInterface dialogInterface);
    public abstract void onTimedOut();
    public abstract void onDismissed();

    public AdvancedMessageDialog(Context context, String text) {
        super(context, R.style.PxDialogTheme);
        this.progressText = text;
        this._context = context;
    }

    public AdvancedMessageDialog(Context context, int themeResId, String text) {
        super(context, themeResId);
        this.progressText = text;
        this._context = context;
    }

    public AdvancedMessageDialog(Context context, int themeResId) {
        super(context, R.style.PxDialogTheme);
        iconThemeResID = themeResId;
        this._context = context;
    }

    public AdvancedMessageDialog(Context context, int themeResId, String text, long timeout /* TIMEOUT in Milliseconds*/) {
        super(context, themeResId);
        this.progressText = text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialogDataInterface = new AdvancedMessageDialogInterface() {
            @Override
    ...
    public AdvancedMessageDialogInterface getProgressDialogDataInterface(){
